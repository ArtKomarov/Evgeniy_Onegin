 ...
 *      Author: Artem
 */
//Получить кол-во символов через fseek, ftell и записать через fread(возможно несколько раз использовать) в буфер
//Создать массив структур содержащих указатели на начало строк из буфера, длину, номер строки (необязательно) во время парсинга через strchr
//Сортировать массив структур
//ctype для проверки строки
/*#include <string.h>
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
